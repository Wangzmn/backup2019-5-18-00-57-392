...
public class UsefulFrameLayout extends FrameLayout {
    /*ViewGroup子类通用代码。
...
//    }
    ...
    //////////////////////////////////////////////////
    public UsefulFrameLayout(Context context) {
        super(context);
    }

    public UsefulFrameLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public UsefulFrameLayout(Context context, AttributeSet attrs, int defStyleAttr) {
